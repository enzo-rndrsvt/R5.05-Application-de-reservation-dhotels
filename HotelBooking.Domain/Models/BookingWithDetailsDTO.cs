...
{
    /// <summary>
    /// Booking with detailed room and hotel information for user display
    /// </summary>
    public class BookingWithDetailsDTO : Entity
    {
        // Booking information
        ...
        // Room images (récupérées depuis la base de données)
